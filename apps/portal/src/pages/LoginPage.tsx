      ...
      <div className="w-full max-w-md">
        <div className="bg-card rounded-lg shadow-xl border p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-center">Portal do Fornecedor</h1>
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            Acesso restrito a fornecedores aprovados.{' '}
            <a href="https://studioos.pro/cadastro-fornecedor" className="text-primary hover:underline">
              Quero me cadastrar
            </a>
          </p>
        </div>
