 ...
 * 
 * NOTA: Materiais são filtrados por organization_id via RLS
 * Cada organização tem seu próprio catálogo de materiais.
 * A política RLS filtra automaticamente pela organização do usuário.
 */
