...
import { PainelCRMV2 as PainelCRM } from '@/components/crm/PainelCRMV2';
import { ListaContatosV2 as ListaContatos } from '@/components/crm/ListaContatosV2';
          ...
          <div className="max-w-7xl mx-auto">
            {view === 'home' && (
              <DashboardExecutivo onNavigate={(v, params) => {
                ...
                } else if (params?.contatoId && v === 'crmContatos') {
